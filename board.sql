...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Дек 08 2013 г., 19:13
...
INSERT INTO `banners` (`id_banners`, `title`, `name`, `link`, `size`, `position`) VALUES
(1, 'Тачки', 'тачки', '<a href="https://sites.google.com/site/viptachki" title="Тачки от RALFA"><img alt="Тачки от RALFA" src="http://www.banner.kiev.ua/b/153/153155.gif"></a><a href="http://artbanner.net"></a>', '200х400', 'right');
...
CREATE TABLE IF NOT EXISTS `board` (
  ...
  `type` enum('s','p','u','o','c','d','t') NOT NULL DEFAULT 'p' COMMENT 'тип объявления(продам, куплю, меняю, сдам, сниму)',
  `autor` varchar(255) NOT NULL,
  `title` varchar(255) NOT NULL,
  `email` varchar(255) NOT NULL,
  `url` varchar(255) NOT NULL,
  `click` smallint(6) NOT NULL DEFAULT '0' COMMENT 'количество просмотров',
  `contacts` text NOT NULL,
  `text` text NOT NULL,
  `price` int(11) unsigned NOT NULL,
  `video` varchar(128) DEFAULT NULL,
  `hits` int(11) NOT NULL DEFAULT '0',
  `checked` enum('yes','no','edit') NOT NULL DEFAULT 'no' COMMENT 'одобрено , не одобрено, проверяется',
  ...
  `highlight` smallint(1) NOT NULL DEFAULT '0',
  `highlight_time` int(11) NOT NULL DEFAULT '0',
  `currency` enum('грн.','$','&pound;','&yen;','&euro;') NOT NULL DEFAULT 'грн.',
  PRIMARY KEY (`id`),
  KEY `id_category` (`id_category`),
  KEY `user_id` (`user_id`),
  KEY `email` (`email`),
  KEY `id_city` (`id_city`),
  KEY `id_region` (`id_region`,`id_country`),
  KEY `vip` (`vip`),
  KEY `type` (`type`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 PACK_KEYS=0 CHECKSUM=1 AUTO_INCREMENT=24 ;

--
-- Дамп данных таблицы `board`
--

INSERT INTO `board` (`id`, `id_category`, `user_id`, `type`, `autor`, `title`, `email`, `url`, `click`, `contacts`, `text`, `price`, `video`, `hits`, `checked`, `top_time`, `tags`, `time_delete`, `date_add`, `id_city`, `id_region`, `id_country`, `vip`, `viptime`, `highlight`, `highlight_time`, `currency`) VALUES
(1, 15, 2, 's', 'qwerty', 'Продам дом 1000 кв.м', 'foreach@mail.ru', '', 16, '423423423423', 'Родам дом. На берегу моря. Песное отопление. Сарай, подвал. Огород 15 сотк. Колдец во дворе. Дом теплый. Во дворе асвалт. Засем рунгаисся насяльника.', 10000000, '', 0, 'no', 0, '', 30, 1357775967, 2616, 2615, 2614, 0, 0, 0, 0, 'грн.'),
(2, 15, 2, 'p', 'Грицацуй', 'Куплю хатку-малатку', 'aasdas@mail.ru', '', 9, 'Трубы теплотрассы', 'Куплю каку нибудь хатку в Монако', 10, '', 0, 'no', 0, '', 30, 1357775980, 3545, 3529, 3159, 0, 0, 0, 0, 'грн.'),
(4, 15, 2, 'u', 'www', 'Меняю хату на шо-нибудь', '', '', 20, 'dfffffffffffffffffffffffffffdddddddddd', 'zcxczxczxczxc', 234234, '', 0, 'no', 0, NULL, 30, 1357755821, 9945, 9943, 9908, 0, 0, 0, 0, 'грн.'),
(5, 15, 2, 'u', 'rrrrrrrrrrrr', 'Меняю сало на запорожец', '', '', 1, 'ыфвфывфыв фыв фвфы фывфывфывфы фвфыв фывфывфывфывфывфыввфывфы', 'фывфыв ыфвфывф ывфывфыв', 22222222, '', 0, 'no', 0, NULL, 30, 1357857068, 10074, 10061, 9908, 0, 0, 0, 0, 'грн.'),
(6, 15, 14, 'p', 'aaaaaaaaaaaaaa', 'Основная задача сайта представление товаров и услуг данной фирмы, технических статей и контактной информации', '', '', 4, 'wwersdf dfsdfsdfsdf fdf sdsddsfsdfsdfsdfsdfsdfsdfsdfsdf sdfsd fsdfsd', 'Нужен оригинальный дизайн, соответствующий тематике сайта.\r\n Приветствуется движок DLE.\r\n Пример подходящих по структуре сайтов apogey.in.ua, himves2000.com.ua.\r\n Поэтапная оплата', 1111111, '', 0, 'no', 0, NULL, 30, 1359333060, 10110, 10094, 9908, 0, 0, 0, 0, 'грн.'),
(7, 21, 2, 's', 'ппп', 'Продам жигули новые', '', '', 3, 'чываыва ываываыва', 'Продам жигули новые с завода 2101', 100, '', 0, 'no', 0, NULL, 30, 1358683081, 10098, 10094, 9908, 0, 0, 0, 0, '&euro;'),
(8, 21, 2, 's', 'Форд 32 го года', 'Форд 32 го года', '', '', 1, 'Форд 32 го года', 'Форд 32 го года. Немецкий. Не дорого.', 22222, '', 0, 'no', 0, NULL, 30, 1358683581, 10498, 10480, 9908, 0, 0, 0, 0, '$'),
(9, 18, 2, 's', 'цуйцуйц', 'Нефтедобывающие платформы.', '', '', 2, 'вапвапв апвапвап ввапвап вапв ва пвапвапвап вап ва пвап вавап        вапвапвапвапвапвапвапва пвап вап вап вапва пвапвапв', 'Продаю нефтеплатформы в Норвегии.', 2147483647, '', 0, 'no', 0, NULL, 30, 1358683688, 10647, 10633, 9908, 0, 0, 0, 0, '&euro;'),
(10, 17, 2, 'p', 'dfgdfgdf', 'не дорого', '', '', 1, 'вапвапва', 'вапвапвапвап', 2000000000, '', 0, 'no', 0, NULL, 30, 1358683816, 10496, 10480, 9908, 0, 0, 0, 0, '$'),
(11, 23, 2, 's', 'ыаывы', 'Икарус', '', '', 1, 'вапвапва', 'вапвапва', 45862, '', 0, 'no', 0, NULL, 30, 1358683915, 10244, 10227, 9908, 0, 0, 0, 0, 'грн.'),
(12, 20, 2, 's', 'нкенкен', 'продам мужа.', '', '', 2, 'вапвапвапв', 'Редкосная недвижимость. С дивана не сдвинешь.', 1, '', 0, 'no', 0, NULL, 30, 1358684009, 10122, 10111, 9908, 0, 0, 0, 0, 'грн.'),
(16, 17, 0, 's', 'gdfgdfgd', 'fdgdfgdfgd', '', '', 1, 'dfgdfgdfgdf', 'sadasdasdasd', 312312, '', 0, 'no', 0, NULL, 30, 1359328796, 9944, 9943, 9908, 0, 0, 0, 0, '$'),
(17, 15, 0, 's', 'eqweqweqw', 'ewqqweqwe', '', '', 2, 'qweqweqwe', 'qweqweqwe', 23423423, '', 0, 'no', 0, NULL, 30, 1359332567, 9946, 9943, 9908, 0, 0, 0, 0, '$'),
(18, 20, 14, 'p', 'wwwwwwwwww', 'wwwwwwwww', '', '', 6, 'wwwwwwwwww', 'wwwwwwwwwwww', 33333333, '', 0, 'no', 0, NULL, 30, 1359332831, 9978, 9964, 9908, 0, 0, 0, 0, 'грн.'),
(19, 16, 2, '', 'fffffffff', 'ffffffffffffffffff', '', '', 3, 'fffffffffffffff', 'ffffffffffffff', 55555555, '', 0, 'no', 0, NULL, 30, 1359496527, 9945, 9943, 9908, 0, 0, 0, 0, '$'),
(20, 15, 0, 'p', 'kjhkjhkj', 'aaaaaaaaaa', '', '', 2, 'hkjghkjhkljh khlkjhlkj', 'kjlkjlk lkjhlkjhlkj ', 79979, '', 0, 'no', 0, NULL, 30, 1361985460, 9945, 9943, 9908, 0, 0, 0, 0, '$'),
(21, 16, 0, 's', 'eeeeeeeee', 'eeeeeeeeeeeeeee', '', '', 2, 'eeeeeeeeeeeeeee', 'eeeeeeeeeeee', 444444444, '', 0, 'no', 0, NULL, 30, 1361986206, 10003, 10002, 9908, 0, 0, 0, 0, '$'),
(22, 15, 0, 's', 'wssdf', 'sdfsdsdf', '', '', 10, 'sdfsdfsd', 'sdfsdsdfsd', 423423, '', 0, 'no', 0, NULL, 30, 1361986397, 10184, 10165, 9908, 0, 0, 0, 0, 'грн.'),
(23, 15, 0, 's', 'dfsdfsd', 'sdfsdfsd', '', '', 1, 'dfsdfsd sdfsdfsd', 'sdf sdfsdfsdfsdfsd', 2423423, '', 0, 'no', 0, NULL, 30, 1361998841, 10047, 10002, 9908, 0, 0, 0, 0, 'грн.');
...
CREATE TABLE IF NOT EXISTS `category` (
  ...
  `child` smallint(1) NOT NULL DEFAULT '0',
  `name_cat` varchar(255) NOT NULL,
  `description` varchar(255) NOT NULL,
  `img` varchar(255) NOT NULL,
  `sort_index` smallint(3) NOT NULL,
  `type_filters` int(4) DEFAULT '1',
  PRIMARY KEY (`id`),
  KEY `root_category` (`parent_id`),
  KEY `type_filters` (`type_filters`)
...
INSERT INTO `category` (`id`, `parent_id`, `child`, `name_cat`, `description`, `img`, `sort_index`, `type_filters`) VALUES
(1, 0, 0, 'Недвижимость', 'Покупка, продажа, обмен, аренда недвижимости. Коммерческая недвижимость. Земельные участки.', 'йййй', 1, 2),
(2, 0, 0, 'Транспорт', 'Продажа, покупка автомобилей и спец. техники. Обмен. Аренда. Транспортные услуги.', 'цццц', 2, 3),
(3, 0, 0, 'Строительство и ремонт', 'Объявления о продаже, покупке стройматериалов и оборудования для строительства и ремонта. Услуги по ремонту помещений.', 'цццццц', 3, 3),
(4, 0, 0, 'Мебель', 'Объявления о продаже, покупке, обмену мебели, фурнитуры и аксессуаров.  ', 'йййййй', 4, 3),
(5, 0, 0, 'Бытовая техника', 'Все,что касается бытовой техники, от миксеров и утюгов, до холодильников и домашних кинотеатров.', 'ййййййй', 5, 3),
(6, 0, 0, 'Мобильные устройства', 'Покупка, продажа, обмен мобильных устройств и аксессуаров к ним. Телефоны, смартфоны, планшеты, КПК и другое.', 'фффффф', 6, 3),
(7, 0, 0, 'Компьютерная техника', 'Компьютеры, ноутбуки и прочие ультрабуки. Компьютерные комплектующие и аксессуары. Переферийные устройства - принтеры, факсы, МФУ и прочее. Расходные материалы.', 'сссссссс', 7, 3),
(8, 0, 0, 'Детский мир', 'Все для детей. Товары, услуги. ', 'еееее', 8, 3),
(9, 0, 0, 'Сад - огород', 'Инструменты, техника, приборы, материалы для сельско-хозяственных работ.', 'ммммммм', 9, 4),
(10, 0, 0, 'Животные', 'Продажа, покупка животных. Корма для животных. Средства для ухода. Объявления о пропаже или найденых животных.', 'тттттт', 10, 4),
(11, 0, 0, 'Растения', 'Комнатные, садовые, экзотические рстения. Семена. ', 'иииии', 11, 3),
(12, 0, 0, 'Спорт, туризм', 'Все для туризма и занятий спортом.', 'тттт', 12, 3),
(13, 0, 0, 'Искусство', 'Предметы старины, искусства, монеты, книги, журналы.', 'яяяяя', 13, 3),
(14, 0, 0, 'Услуги', 'Объявления по оказанию услуг. Трубуются услуги.', 'ччч', 14, 5),
(15, 1, 0, 'Дома, дачи, участки', 'Продажа, покупка, обмен, сдам, сниму дом, дачу, земельный участок.', 'ьььь', 1, 2),
(16, 1, 0, 'Земельные участки', 'Продажа, покупка, аренда земли под застройку, сельское хозяйство, производство.', 'ссссс', 2, 2),
(17, 1, 0, 'Квартиры', 'Продажа, покупка, аренда, обмен квартир.', 'иии', 3, 2),
(18, 1, 0, 'Коммерческая недвижимость', 'Продажа, покупка, обмен, аренда коммерческих и производственных помещений, офисов.', 'сссс', 4, 2),
(19, 1, 0, 'Комнаты', 'Продажа, покупка, обмен, аренда комнат.', 'иии', 5, 2),
(20, 1, 0, 'Другая недвижимость', 'Недвижимость которая не подходит ни под одну из выше перечисленных категорий.', 'сссссссс', 6, 2),
(21, 2, 0, 'Легковые авто', 'Прожажа, покупка, обмен, аренда легковых автомобилей', 'ееееее', 1, 2),
(22, 2, 0, 'Грузовые авто', 'Продажа, покупка, аренда, обмен грузовых автомобилей', 'ммммм', 2, 2),
(23, 2, 0, 'Автобусы, микроавтобусы', 'Продажа, покупка, аренда, обмен', 'ммм', 3, 2),
(24, 2, 0, 'Прицепы, полуприцепы', 'Продажа, покупка, аренда, обмен', 'иии', 4, 2),
(25, 2, 0, 'Спец. техника', 'Продажа, покупка, аренда, обмен', 'иииии', 5, 2),
(26, 2, 0, 'Водный транспорт', 'Продажа, покупка, аренда, обмен', 'иии', 6, 2),
(27, 2, 0, 'Авиационный транспорт', 'Продажа, покупка, аренда, обмен', 'иии', 7, 2),
(28, 2, 0, 'Вело-Мото', 'Продажа, покупка, обмен', 'иии', 7, 3),
(29, 2, 0, 'Запчасти', 'Продажа, покупка,  обмен', 'иии', 8, 3),
(30, 2, 0, 'Услуги', 'Транспортные услуги', 'иии', 9, 5),
(31, 3, 0, 'Стройматериалы', 'Продажа, покупка, обмен', 'иии', 1, 3),
(32, 3, 0, 'Оборудование', 'Продажа, покупка, аренда, обмен', 'иии', 2, 2),
(33, 3, 0, 'Услуги', 'Предоставление услуг по ремонту и строительству', 'иии', 3, 5),
(34, 4, 0, 'Для дома', 'Продажа, покупка, обмен', 'иии', 1, 3),
(35, 4, 0, 'Для офиса, магазина', 'Продажа, покупка, аренда, обмен', 'иии', 2, 2),
(36, 4, 0, 'Материалы, фурнтура', 'Продажа, покупка, обмен', 'иии', 3, 3),
(37, 5, 0, 'Аудиотехника', 'Продажа, покупка, обмен', 'иии', 1, 3),
(38, 5, 0, 'Видеотехника', 'Продажа, покупка,  обмен', 'иии', 2, 3),
(39, 5, 0, 'Крупная бытовая техника', 'Продажа, покупка, обмен', 'иии', 3, 3),
(40, 5, 0, 'Мелкая бытовая техника', 'Продажа, покупка, обмен', 'иии', 4, 3),
(41, 5, 0, 'Прочая техника', 'Продажа, покупка, аренда, обмен', 'иии', 5, 2),
(42, 7, 0, 'Компьютеры', 'Продажа, покупка, обмен', 'иии', 1, 3),
(43, 7, 0, 'Мониторы', 'Продажа, покупка, обмен', 'иииии', 2, 3),
(44, 7, 0, 'Принтеры, факсы, копировальная техника', 'Продажа, покупка, обмен', 'иии', 3, 3),
(45, 7, 0, 'Комплектующие', 'Продажа, покупка, обмен', 'иии', 4, 3),
(46, 7, 0, 'Прочее', 'Продажа, покупка, обмен', 'иии', 5, 3),
(47, 7, 0, 'Программы', 'Программное обеспечение для компьютерной техники', 'тттт', 4, 3),
(48, 6, 0, 'Телефоны', 'Продажа, покупка, обмен', 'иии', 1, 3),
(49, 6, 0, 'КПК', 'Продажа, покупка, обмен', 'иии', 2, 3),
(50, 6, 0, 'Смартфоны', 'Продажа, покупка, обмен', 'иии', 3, 3),
(51, 6, 0, 'Планшеты', 'Продажа, покупка, обмен', 'иии', 5, 3),
(52, 6, 0, 'Запчасти', 'Продажа, покупка, обмен', 'иии', 5, 3),
(53, 6, 0, 'Аксессуары', 'Продажа, покупка, обмен', 'иии', 6, 3),
(54, 8, 0, 'Для самых маленьких', 'Продажа, покупка, обмен', 'иии', 1, 3),
(55, 8, 0, 'Одежда, обувь', 'Продажа, покупка, обмен детской одежды и обуви', 'тттттт', 3, 3),
(56, 8, 0, 'Детская мебель', 'Продажа, покупка, обмен детской мебели', 'иии', 5, 3),
(57, 8, 0, 'Коляски, автокресла', 'Продажа, покупка, обмен колясок, автокресел и других средств передвижения и безопасности', 'тттт', 6, 3),
(58, 8, 0, 'Игрушки', 'Продажа, покупка, обмен', 'тттт', 7, 3),
(59, 8, 0, 'Прочее', 'Продажа, покупка, обмен всего, что не подошло под другие детские категории', 'тттт', 8, 3),
(60, 9, 0, 'Инвентарь', 'Продажа, покупка, обмен', 'тттт', 1, 3),
(61, 9, 0, 'Саженцы, семена', 'Продажа, покупка, обмен', 'тттт', 2, 3),
(62, 9, 0, 'Удобрения', 'Продажа, покупка, обмен', 'тттт', 3, 3),
(63, 10, 0, 'Крупные животные', 'Продажа, покупка крупных домашних животных', 'тттт', 1, 4),
(64, 10, 0, 'Кошки', 'Продажа, покупка', 'тттт', 2, 4),
(65, 10, 0, 'Собаки', 'Продажа, покупка', 'иии', 3, 4),
(66, 10, 0, 'Птицы', 'Продажа, покупка, обмен', 'тттт', 5, 3),
(67, 10, 0, 'Экзотические', 'Продажа, покупка, обмен', 'тттт', 7, 3),
(68, 10, 0, 'Разное', 'Продажа, покупка, обмен', 'ммм', 8, 3),
(69, 11, 0, 'Комнатные', 'Продажа, покупка, обмен комнатных растений', 'тттт', 1, 3),
(70, 11, 0, 'Декоративные', 'Продажа, покупка, обмен декоративных растений', 'тттттт', 2, 3),
(71, 11, 0, 'Семена, саженцы', 'Продажа, покупка, обмен различных саженцев и семенного материала', 'тттт', 3, 3),
(72, 12, 0, 'Спорт. инвентарь', 'Продажа, покупка, аренда, обмен', 'иии', 1, 2),
(73, 12, 0, 'Туристический инвентарь', 'Продажа, покупка, аренда, обмен', 'сссссссс', 2, 2),
(74, 12, 0, 'Услуги', 'Поиск и предложение услуг по туризму, спорту и отдыху', 'сссс', 3, 5),
(75, 12, 0, 'Разное', 'Все для туризма и занятий спортом.', 'ссссс', 4, 2),
(76, 13, 0, 'Книги', 'Продажа, покупка, обмен', 'ммм', 1, 3),
(77, 13, 0, 'Художественное искусство', 'Продажа, покупка, обмен', 'ееееее', 2, 3),
(78, 13, 0, 'Предметы старины', 'Продажа, покупка, обмен', 'куцкцу', 3, 3),
(79, 13, 0, 'Разное', 'Продажа, покупка, обмен', 'ппп', 4, 3),
(80, 14, 0, 'Предлагаю услуги', 'Предоставление различных услуг', 'иии', 1, 6),
(81, 14, 0, 'Требуются услуги', 'Здесь размещены объявления в которых людям требуются какие либо услуги', 'ммм', 2, 7);
...
CREATE TABLE IF NOT EXISTS `comments` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_comments_board1` (`id_board`)
...
CREATE TABLE IF NOT EXISTS `company` (
  ...
  `name` varchar(255) CHARACTER SET armscii8 DEFAULT NULL,
  `logo` varchar(255) CHARACTER SET armscii8 DEFAULT NULL,
  `description` text CHARACTER SET armscii8,
  `contacts` text CHARACTER SET armscii8,
  `top` enum('1','0') CHARACTER SET armscii8 DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `config` (
  `board_works` enum('only_admin','all') NOT NULL DEFAULT 'all',
  `add_new_ads` enum('yes','no') NOT NULL DEFAULT 'yes',
  `add_new_news` enum('yes','no') NOT NULL DEFAULT 'yes',
  `id` smallint(1) NOT NULL DEFAULT '0',
  `cache_clear` enum('auto','timer') NOT NULL DEFAULT 'timer',
  `scache` smallint(1) NOT NULL DEFAULT '0',
  `scache_expire` int(11) NOT NULL DEFAULT '3600',
  `scache_exp_expire` int(11) NOT NULL DEFAULT '43200',
  `kcache` smallint(1) NOT NULL DEFAULT '1',
  `add_new_only_user` enum('yes','no') NOT NULL DEFAULT 'no',
  `money_service` enum('yes','no') NOT NULL DEFAULT 'no',
  `top_status_days` smallint(3) NOT NULL DEFAULT '7',
  `top_prefix` varchar(32) NOT NULL,
  `top_price` varchar(32) NOT NULL,
  `top_number` varchar(32) NOT NULL,
  `select_status_days` smallint(3) NOT NULL DEFAULT '7',
  `select_prefix` varchar(32) NOT NULL,
  `select_price` varchar(32) NOT NULL,
  `select_number` varchar(32) NOT NULL,
  `wm_money_service` enum('yes','no') NOT NULL DEFAULT 'no',
  `wm_mode` enum('on','off') NOT NULL DEFAULT 'on',
  `wm_purse` varchar(13) NOT NULL,
  `wm_type` varchar(3) NOT NULL DEFAULT 'WMZ',
  `wmprice_vip` smallint(6) NOT NULL DEFAULT '20',
  `wmprice_select` smallint(6) NOT NULL DEFAULT '10',
  `subscribe_theme` varchar(255) NOT NULL,
  `subscribe_text` text NOT NULL,
  `subscribe_from` varchar(128) NOT NULL,
  `subscribe_limit` smallint(3) NOT NULL DEFAULT '50',
  `subscribe_sleep` smallint(1) NOT NULL DEFAULT '0',
  `view_nonactiv_contacts` enum('yes','no') NOT NULL DEFAULT 'no',
  `count_symb_autor` smallint(4) NOT NULL DEFAULT '64',
  `count_symb_title` smallint(4) NOT NULL DEFAULT '128',
  `count_symb_url` smallint(4) NOT NULL DEFAULT '64',
  `count_symb_contacts` smallint(4) NOT NULL DEFAULT '512',
  `count_symb_text` smallint(4) NOT NULL DEFAULT '1024',
  `count_adv_on_index` smallint(2) NOT NULL DEFAULT '10',
  `tags_generate` enum('yes','no') NOT NULL DEFAULT 'no',
  `kaleidoscope` enum('yes','no') NOT NULL DEFAULT 'yes',
  `count_show_img_kaleidoscope` smallint(2) NOT NULL DEFAULT '6',
  `add_url` enum('yes','no') NOT NULL DEFAULT 'yes',
  `view_comments` enum('yes','no') NOT NULL DEFAULT 'yes',
  `clouds_tags` enum('yes','no') NOT NULL DEFAULT 'yes',
  `add_comments` enum('yes','no') NOT NULL DEFAULT 'yes',
  `stop_words` text NOT NULL,
  `upl_image_size` int(9) NOT NULL DEFAULT '300000',
  `mail_friends` enum('yes','no') NOT NULL DEFAULT 'yes',
  `admin_mail` varchar(64) NOT NULL,
  `print_keywords` enum('yes','no') NOT NULL DEFAULT 'yes',
  `print_vip` enum('yes','no') NOT NULL DEFAULT 'yes',
  `count_print_vip` smallint(2) NOT NULL DEFAULT '3',
  `print_news` enum('yes','no') NOT NULL DEFAULT 'yes',
  `count_print_news` smallint(2) NOT NULL DEFAULT '5',
  `count_news_in_page` smallint(2) NOT NULL DEFAULT '10',
  `print_stat` enum('yes','no') NOT NULL DEFAULT 'yes',
  `limit_pagination_on_page` smallint(2) NOT NULL DEFAULT '5',
  `mail_about_new_mess` enum('yes','no') NOT NULL DEFAULT 'no',
  `upload_images` enum('yes','no') NOT NULL DEFAULT 'yes',
  `count_images_for_users` smallint(6) NOT NULL DEFAULT '1',
  `width_small_images` smallint(4) NOT NULL DEFAULT '0',
  `width_normal_images` smallint(4) NOT NULL DEFAULT '0',
  `width_cat_images` smallint(3) NOT NULL DEFAULT '50',
  `width_news_images` smallint(3) NOT NULL DEFAULT '150',
  `add_link_to_video` enum('yes','no') NOT NULL DEFAULT 'yes',
  `captcha` enum('yes','no') NOT NULL DEFAULT 'yes',
  `edit_message` enum('yes','no') NOT NULL DEFAULT 'yes',
  `edit_comments` enum('yes','no') NOT NULL DEFAULT 'yes',
  `anti_link` enum('yes','no') NOT NULL DEFAULT 'yes',
  `day_for_notice_autor` smallint(1) NOT NULL DEFAULT '3',
...
INSERT INTO `favorites` (`id`, `board_id`, `user_id`) VALUES
(29, 2, 14),
(30, 19, 14),
(31, 8, 14),
(32, 12, 14),
...
INSERT INTO `location` (`id`, `board_id`, `latitude`, `longitude`, `map_zoom_level`) VALUES
(1, 20, 50.4435130524581, 30.52001953125, 16),
(2, 21, 48.1348764206913, 37.7551174163818, 16),
(3, 22, 50.4630569050118, 30.63167989254, 14),
(4, 23, 47.1693155422103, 37.5342375040054, 14);
...
INSERT INTO `news` (`id`, `title`, `autor`, `logo`, `short`, `full`, `keywords`, `descr`, `hits`, `date`) VALUES
(1, 'first news', 'admin', 'sdfsdfsdf', 'Во Львове правоохранители задержали правонарушителя, который сообщил о ложном минировании вокзала и аэропорта, им оказался несовершеннолетний житель города. Об этом РБК-Украина сообщил источник в СБУ во Львовской области. Юноша сегодня сообщил о ложном минировании Львовского аэропорта.', 'Во Львове правоохранители задержали правонарушителя, который сообщил о ложном минировании вокзала и аэропорта, им оказался несовершеннолетний житель города. Об этом РБК-Украина сообщил источник в СБУ во Львовской области.\r\n\r\nЮноша сегодня сообщил о ложном минировании Львовского аэропорта. Вчера правонарушитель также сообщил о ложном минировании вокзала, из-за чего были эвакуированы пассажиры.\r\n\r\nКроме того, "шутник" в течение двух дней, 14 и 15 сентября, сообщал о ложных минированиях львовских супермаркетов.\r\n\r\nЧитайте также: Сообщение о минировании вокзала во Львове оказалось ложным\r\n\r\nНапомним, 13 сентября с.г. в ходе проведения оперативно-розыскных мероприятий относительно ложного сообщения о минировании киевской станции метро "Вокзальная", правоохранители в течение нескольких часов установили и задержали 25-летнюю киевлянку, которая осуществила это сообщение. В содеянном она полностью призналась, однако мотива своей шутки объяснить не смогла.\r\n\r\nЧитайте также: В Киеве не работала станция метро "Вокзальная" из-за сообщения о заминировании\r\n\r\nРанее, 8 сентября, в аэропорту "Жуляны" из-за ложного сообщения о минировании самолета рейс в Польшу был задержан на пять часов. Один из пассажиров во время посадки на самолет, который отправлялся в Польшу, сообщил стюардессе, что в самолете находится подозрительный предмет, похожий на взрывное устройство. Сотрудники аэропорта эвакуировали 163 пассажира рейса "Киев-Катовице" и семерых членов экипажа из самолета Airbus-320. В ходе осмотра самолета, пассажиров, багажа и ручной клади никаких взрывоопасных предметов обнаружено не было.\r\n\r\nНапомним, 25 августа в аэропорту "Симферополь" россиянка сообщила о взрывном устройстве в багаже. Во время регистрации пассажиров рейса Симферополь - Домодедово при прохождении контроля на безопасность одна из пассажирок рейса, проявляя явные признаки алкогольного опьянения, сообщила о том, что в ее багаже ​​находится бомба, взрыв которой произойдет в самолете. В безопасную зону были эвакуированы 260 человек, в том числе 108 пассажиров рейса, экипаж и работники аэропорта. Взрывоопасных предметов обнаружено не было.\r\n\r\n21 августа из терминалов "B" и "F" международного аэропорта "Борисполь" также  производилась эвакуация пассажиров из-за сообщения о минировании. Сообщалось, что звонок поступил от психически неуравновешенного гражданина.  Он звонил дважды с промежутком в несколько минут с одной и той же фразой: "Аэропорт заминирован".\r\n\r\n16 августа с главного ж/д вокзала Львова эвакуировали более тысячи человек в связи с ложным сообщением о минировании. Ранее в Киеве милиция задержала мужчину, сообщившего о заминировании станции метро "Университет".', 'gdfgdfg', 'xcvxcvxcvxc', 0, 2147483647),
(2, 'second news', 'admin', 'xcvxvxcxc', 'Сегодня руководители партии Юлии Тимошенко «Батькивщина» проведут пресс-конференцию, на которой обещают сделать сенсационные заявления. Как стало известно «НГ», речь может идти об обвинении лидеров правящей Партии регионов в причастности к совершенному в 1996 году убийству донецкого бизнесмена и ...', 'Сегодня руководители партии Юлии Тимошенко «Батькивщина» проведут пресс-конференцию, на которой обещают сделать сенсационные заявления. Как стало известно «НГ», речь может идти об обвинении лидеров правящей Партии регионов в причастности к совершенному в 1996 году убийству донецкого бизнесмена и депутата Верховной Рады Евгения Щербаня. Поводом к выступлению оппозиции послужили субботние откровения бывшего охранника Кучмы Николая Мельниченко: он в унисон с властью заявил, что Тимошенко причастна к убийству Щербаня. \r\n\r\nНа днях Мельниченко, который скрывается в США, дал показания американскому Министерству юстиции. В социальной сети он коротко пересказал суть допроса. Бывший охранник Леонида Кучмы, прославившийся тем, что тайно записывал разговоры в кабинете главы государства, заявил, что организатором убийства Щербаня был работавший в тот момент премьер-министром Павел Лазаренко. А деньги исполнителям переводились со счетов фирм, контролировавшихся протеже Лазаренко – Юлией Тимошенко. Из разговоров в кабинете Кучмы Мельниченко сделал вывод, что смысл заказного убийства заключался в попытке взять под контроль бизнес в промышленно развитом регионе Украины. \r\n\r\nКроме того, экс-охранник сообщил, что в июле с.г. к нему обращался получивший политическое убежище в Чехии муж Тимошенко Александр – с предложением дать ложные показания по делу, чтобы обвинить в причастности к одному из самых громких убийств нынешнего президента Януковича. «Свидетельствовать о том, что якобы именно он (Янукович. – «НГ») является заказчиком убийства Щербаня, что у меня якобы есть записи этих разговоров Януковича с Кучмой. При этом сами записи необходимо было сфальсифицировать, создать искусственно из тех оригинальных образцов их голосов, которые у меня есть», – написал Мельниченко на своей странице в соцсети. \r\n\r\n\r\nРанее соратники Тимошенко уже заявляли, что Янукович стал донецким губернатором сразу после убийства Щербаня. По их словам, с этого момента в регионе начался передел собственности в пользу той группы влияния, которая впоследствии переехала в Киев вместе с Януковичем, которого Кучма назначил премьер-министром через несколько лет после убийства Щербаня. Весной заместитель Тимошенко по партии и экс-глава Службы безопасности Украины Александр Турчинов отметил: «Заказчиков можно легко вычислить – посмотреть, кто присвоил имущество Щербаня, кто взял под контроль его бизнес, его предприятия. И тогда будет понятно, что и сейчас эти люди сидят или в парламенте, или находятся на очень серьезных и ответственных должностях. И все следы приведут, безусловно, к Партии регионов». \r\n\r\nУкраинская прокуратура уже полгода проводит следственные действия, обещая выяснить, как было на самом деле. Формальным поводом к возобновлению расследования старого уголовного дела стало прозвучавшее весной заявление сына Щербаня, который неожиданно сообщил, что из разговоров, которые он, будучи подростком, слушал в кабинете отца, ему известно о причастности Тимошенко к организации покушения. До сих пор руководство Генпрокуратуры подтверждало, что Тимошенко в этом уголовном деле имеет статус свидетеля. Хотя время от времени звучали намеки на возможность изменения статуса на «обвиняемую». \r\n\r\nНеделю назад генпрокурор Виктор Пшонка в телевизионном интервью сказал: «К Тимошенко есть многочисленные вопросы. Со счетов ЕЭСУ (корпорации, которой в середине 1990-х руководила Тимошенко. – «НГ») перечислялись деньги тем, кто исполнял убийство (Щербаня. – «НГ»). Почему ее имя вспоминают причастные к тем или иным обстоятельствам? Не будем торопить события, истина должна быть установлена. Виновна она – значит, предстанет перед судом, не будет доказательств – не предстанет перед судом». \r\n\r\nПоказания Мельниченко могли бы стать недостающим звеном в процессе подготовки к предъявлению Тимошенко новых обвинений. Но партия «Батькивщина» вчера поставила под сомнение слова экс-охранника Кучмы. В специальном заявлении было сказано, что Мельниченко длительное время добивался встречи с руководителями партии, предлагая за соответствующий гонорар выступить с показаниями в защиту Тимошенко в деле об убийстве Щербаня. «Однако после категорического отказа пошел на сотрудничество с режимом, для которого запуганные или купленные так называемые «свидетели» давно стали средством для расправы над лидерами оппозиции», – отмечается в заявлении партии. \r\n\r\nИсточник в лагере оппозиции в беседе с корреспондентом «НГ» предположил, что украинская власть нашла управу на Мельниченко, против которого в апреле возобновили уголовные дела по фактам превышения служебных полномочий и разглашения государственной тайны – в связи с незаконной прослушкой кабинета Кучмы. После этого экс-охранник, снова бежавший за границу, был объявлен в розыск по линии Интерпола. В начале августа Мельниченко задержали в Италии, куда он прибыл из США, однако по каким-то причинам почти сразу же выпустили на свободу. Собеседник «НГ» считает, что в этом была заинтересована украинская власть, которая через Мельниченко донесла до Минюста США сведения о причастности Лазаренко и Тимошенко к заказному убийству. «Янукович делает все, чтобы доказать Западу: арестовав Тимошенко, он не избавился от политического конкурента, а посадил уголовницу. Обреченный на вечные скитания Мельниченко оказал украинской власти помощь, я бы сказал, оценимую помощь», – пояснил источник в оппозиционном лагере. \r\n\r\nПолитолог Владимир Фесенко, комментируя ситуацию, согласился: «Похоже, что Мельниченко пытается найти компромиссы с украинской властью. В политическом смысле его заявление можно назвать выгодным официальному Киеву. Но в юридическом поле – не знаю, можно ли использовать показания экс-охранника. Во-первых, он делал записи в кабинете Кучмы не в тот период, когда был убит Щербань. Но даже если спустя несколько лет кто-то в беседе с президентом обмолвился насчет обстоятельств громкого убийства, даже если подлинность заявления была бы доказана, то это просто слова. Факты и вещественные доказательства, подтверждающие, что деньги действительно переводились и что платеж был связан с убийством, – это совсем другое», – отметил эксперт.\r\nПодробнее: http://www.ng.ru/cis/2012-09-17/1_timoshenko.html', 'cvbcvbcv', 'cvbcvbcvbcv', 0, 456456456),
(3, 'xcvxcvxcvxcvxc', 'admin', 'dfgdfgdfgdfg', 'fdgdf dfgdfgdfgdfgdfg', 'dfgdfgdfdfgdf dfg df dfgdfgdfg dg', 'fdgdfgdfg', 'dfgdfgdfgdf', 0, 1348090419);
...
(4, 'Услуги', '<h4>\r\n	Услуги предоставляемые на сегодняшний день:</h4>\r\n<p>\r\n	&nbsp;</p>\r\n<p>\r\n	<img alt="" src="/content/images/Text%20Editor.png" style="float: left; width: 149px; height: 149px;margin-right:15px;margin-bottom:15px;" />Бесплатное размещение объявлений. Приочень простой регистрации. Объявления публикубтся моментально.</p>\r\n<p>\r\n	&nbsp;</p>\r\n<p>\r\n	&nbsp;</p>\r\n<p>\r\n	&nbsp;</p>\r\n<p>\r\n	&nbsp;</p>\r\n<p>\r\n	&nbsp;</p>\r\n<p>\r\n	&nbsp;</p>\r\n<h4>\r\n	Услуги которые будут предоставляться в дальнейшем:</h4>\r\n<p>\r\n	&nbsp;</p>\r\n<p>\r\n	<img alt="" src="/content/images/11.png" style="width: 150px; height: 150px; float: left;margin-right:15px;margin-bottom:15px;" />Вы можете разместить информацию о вашей компании в каталоге компаний. За отдельную плату ваша компания может быть помещена в баннерный блок на главной странице сайта.</p>\r\n<p>\r\n	&nbsp;</p>\r\n<p>\r\n	&nbsp;</p>\r\n<p>\r\n	&nbsp;</p>\r\n<p>\r\n	&nbsp;</p>\r\n<p>\r\n	&nbsp;</p>\r\n<p>\r\n	&nbsp;</p>\r\n<p>\r\n	<img alt="" src="/content/images/exet.ru%20%2863%29.png" style="width: 150px; height: 150px; float: left;margin-right:15px;margin-bottom:15px;" />VIP - объявления. Такие объявления будут размещаться на главной странице сайта. Преимущество в том, что такие объявления увидит больше пользователей.</p>\r\n<p>\r\n	&nbsp;</p>\r\n<p>\r\n	&nbsp;</p>\r\n<p>\r\n	&nbsp;</p>\r\n<p>\r\n	&nbsp;</p>\r\n<p>\r\n	&nbsp;</p>\r\n<p>\r\n	&nbsp;</p>\r\n<p>\r\n	<img alt="" src="/content/images/Desktop%20Picts.png" style="width: 150px; height: 150px; float: left;margin-right:15px;margin-bottom:15px;" />Объявления выделенные цветом. Такие объявления будут заметнее в списке обычных объявлений. Это привлечет потенциальных клиентов.</p>\r\n', 'услуги, платные, дополнительные', 'Дополнительные услуги по размещению рекламы и объявлений', 'services', 1),
(5, 'О проекте', '<p>\r\n	<strong>Доска бесплатных объявлений movmarket.biz&nbsp;</strong> &ndash; это место, где каждый желающий может быстро и легко подать бесплатное объявление, продать, купить или обменять любые товары и услуги.<br />\r\n	<br />\r\n	<strong>Преимущества интернет-объявлений:</strong></p>\r\n<ul>\r\n	<li>\r\n		<strong>скорость</strong> &mdash; объявление публикуется сразу после подачи;</li>\r\n	<li>\r\n		<strong>доступность</strong> &mdash; размещение и просмотр объявлений 24 часа в сутки 7 дней в неделю;</li>\r\n	<li>\r\n		<strong>бесплатно</strong> для всех!</li>\r\n</ul>\r\n<p>\r\n	<br />\r\n	<br />\r\n	<strong>О проекте:</strong><br />\r\n	14 основных разделов:</p>\r\n<ul class="nav nav-pills nav-stacked" id="nav">\r\n	<li>\r\n		<a href="http://board.loc/category/1.html">Недвижимость</a></li>\r\n	<li>\r\n		<a href="http://board.loc/category/2.html">Транспорт</a></li>\r\n	<li>\r\n		<a href="http://board.loc/category/3.html">Строительство и ремонт</a></li>\r\n	<li>\r\n		<a href="http://board.loc/category/4.html">Мебель</a></li>\r\n	<li>\r\n		<a href="http://board.loc/category/5.html">Бытовая техника</a></li>\r\n	<li>\r\n		<a href="http://board.loc/category/6.html">Мобильные устройства</a></li>\r\n	<li>\r\n		<a href="http://board.loc/category/7.html">Компьютерная техника</a></li>\r\n	<li>\r\n		<a href="http://board.loc/category/8.html">Детский мир</a></li>\r\n	<li>\r\n		<a href="http://board.loc/category/9.html">Сад - огород</a></li>\r\n	<li>\r\n		<a href="http://board.loc/category/10.html">Животные</a></li>\r\n	<li>\r\n		<a href="http://board.loc/category/11.html">Растения</a></li>\r\n	<li>\r\n		<a href="http://board.loc/category/12.html">Спорт, туризм</a></li>\r\n	<li>\r\n		<a href="http://board.loc/category/13.html">Искусство</a></li>\r\n	<li>\r\n		<a href="http://board.loc/category/14.html">Услуги</a></li>\r\n</ul>\r\n<div class="right-banner">\r\n	Покрывает все регионы Украины;</div>\r\n<p>\r\n	<strong>В планах:</strong></p>\r\n<ul>\r\n	<li>\r\n		Введение в строй каталога компаний;</li>\r\n	<li>\r\n		Перевод на два языка(украинский и английский);</li>\r\n	<li>\r\n		Ввод в эксплуатацию дополнительных платных сервисов;</li>\r\n	<li>\r\n		Возможность указания объекта на карте;</li>\r\n</ul>\r\n<p>\r\n	<br />\r\n	<strong>Для Вашего удобства:</strong></p>\r\n<ul>\r\n	<li>\r\n		понятная и легкая форма подачи объявления;</li>\r\n	<li>\r\n		возможность добавления фотографий, видеороликов;</li>\r\n	<li>\r\n		удобный поиск объявления, по ключевым словам и контактам;</li>\r\n	<li>\r\n		удобная фильтрация объявлений;</li>\r\n	<li>\r\n		возможность регистрации и доступ к личному кабинету, объединяющему все необходимые функции и информацию.</li>\r\n</ul>\r\n', 'О проекте, movmarket.biz, Доска бесплатных объявлений', 'Информация о проекте Доска бесплатных объявлений movmarket', 'about', 1),
(6, 'Правила размещения', '<p>\r\n	<strong>Размещение объявления</strong></p>\r\n<ul>\r\n	<li>\r\n		Вы можете размещать объявления на сайте после заполнения специальной формы с указанием параметров предлагаемых товаров или услуг. Поля в форме отмеченные красной звездочкой являются обязательными для заполнения. Остальные поля не обязательно заполнять.</li>\r\n	<li>\r\n		Вы имеете возможность зарегистрироваться на сайте с целью получения дополнительных сервисов или услуг, заполнив форму с указанием вашего электронного адреса, к которому имеете доступ только вы, и пароля. После этого вы можете размещать объявления. Активация не требуется. После регистрации становится доступным личный кабинет, где вы можете управлять своими объявлениями.</li>\r\n	<li>\r\n		Вы несете ответственность за все действия с использованием своего электронного адреса и пароля для входа в систему. Вы имеете право пользоваться услугами сайта только при помощи собственного электронного адреса и пароля.</li>\r\n	<li>\r\n		Вы обязаны по мере возможности следить за сохранностью своего пароля и не раскрывать его посторонним. Вы не имеет права передавать или продавать свои данные для входа в систему сайта третьим лицам.</li>\r\n	<li>\r\n		Вы обязаны немедленно изменить данные для входа в систему, если у вас есть причины подозревать, что эти данные были раскрыты или могут быть использованы третьими лицами.</li>\r\n	<li>\r\n		Когда вы размещаете информацию о товаре/услуге на сайте, вы обязуетесь разместить информацию о них в соответствии c настоящим соглашением и правилам сайта и предоставить точную и полную информацию о товаре/услуге и условиях продажи товара или предоставления услуг. Размещая товар или услугу, вы подтверждаете, что имеете право продавать этот товар или оказывать данную услугу.</li>\r\n	<li>\r\n		Вы имеет право продавать на сайте любые принадлежащие вам товары при условии соблюдения действующего законодательства Украины. Вы гарантируете, что предлагаемые вами товары соответствуют нормам качества, установленным законодательством Украины и свободны от притязаний третьих лиц.</li>\r\n	<li>\r\n		Вы имеете право размещать объявления с предложением любых услуг, при условии соответствия их нормам действующего законодательства Украины. Вы гарантируете, что предлагаемые услуги, в случае если оказание их требует специального разрешения, будут осуществлены в соответствии с требованиями законодательства Украины.</li>\r\n	<li>\r\n		Вы обязаны тщательно проверить всю информацию о товарах и услугах, размещенных вами на сайте, и, в случае обнаружения неверной информации, добавить необходимые сведения в описание товара или услуги. Если это не возможно, исправить неверную информацию.</li>\r\n	<li>\r\n		Описание товара или услуг, составленное вами, должно содержать условия продажи этого товара или услуги.</li>\r\n	<li>\r\n		Условия доставки должны включаться в описание товара, а условия оказания услуг в описание услуги. Условия продажи товара и оказания услуг, составленные вами, не должны противоречить настоящему соглашению и действующему законодательству Украины.</li>\r\n	<li>\r\n		Администрация имеет право переместить, завершить или продлить срок демонстрации товара или услуги по техническим причинам, находящимся под контролем или вне контроля Администрации. Сайт имеет право прекратить демонстрацию объявления, если вы зарегистрировали товар или услугу, с нарушением или видимостью нарушения условий настоящего соглашения или действующего законодательства Украины.</li>\r\n	<li>\r\n		Услуги по размещению объявления на сайте, считаются исполненными с момента публикации этих объявлений.</li>\r\n	<li>\r\n		Объявления проходят пост-модерацию.</li>\r\n</ul>\r\n<p>\r\n	&nbsp;<strong>Администрация и модераторы сайта вправе</strong></p>\r\n<ul>\r\n	<li>\r\n		вносить в текст объявления правки, касающиеся орфографии и пунктуации, не влияющие на общий смысл объявления;</li>\r\n	<li>\r\n		переносить объявления в другие разделы сайта в случае выявления более подходящего раздела;</li>\r\n	<li>\r\n		отказать в публикации, если она не соответствуют тематике выбранных разделов, либо не соответствуют настоящему соглашению, а так же право ограничивать количество объявлений от одного пользователя в целях удобства посетителей Сайта без объяснения причин.</li>\r\n</ul>\r\n<p>\r\n	&nbsp;Разрешается разместить одно объявление касательно одного конкретного предмета, объекта имущества, вакансии, услуги. Одно и то же объявление не может быть дано в двух разных разделах или рубриках.</p>\r\n<p>\r\n	<br />\r\n	&nbsp;Не допускается указание некорректных характеристик предмета предложения в объявлении. В том числе указание цены, не соответствующей фактической цене реализации товара или услуги. Цена должна быть указана полностью за весь товар или услугу (Например: при продаже предмета в рассрочку, цена должна быть указана полностью, а не в зависимости от срока рассрочки платежа.)</p>\r\n<p>\r\n	<br />\r\n	&nbsp;Заголовок размещаемого объявления должен соответствовать тексту самого объявления и не должен содержать контактную или персональную информацию о пользователе.</p>\r\n<p>\r\n	<br />\r\n	&nbsp;Фото, демонстрирующее товар/услугу, предлагаемые пользователем, должно соответствовать заголовку и тексту объявления. На фото должен быть изображен только предлагаемый объект.</p>\r\n<p>\r\n	<br />\r\n	&nbsp; Право использования сведений, предоставленных другими пользователями, ограничивается настоящим соглашением<br />\r\n	&nbsp;Администрация не несет ответственности за содержание объявления или гиперссылки на ресурсы, указанные в описании объявления.</p>\r\n', 'Правила размещения рекламы и объявлений.', 'Правила размещения рекламы и объявлений.', 'rules', 1),
(7, 'ЧаВо - Часто задаваемые вопросы', '<p>\r\n	<strong>Вопрос</strong>: Сколько звездна небе?</p>\r\n<p>\r\n	<strong>Ответ:</strong> Столько же сколько капель в море.</p>\r\n<p>\r\n	&nbsp;</p>\r\n<p>\r\n	<strong>Вопрос</strong>: Сколько весит килограмм гвоздей?</p>\r\n<p>\r\n	<strong>Ответ</strong>: Зачем мне твой холодильник, если я не курю.</p>\r\n', 'йцуйцу', 'уйцуйцуйц', 'faq', 1);
...
INSERT INTO `photo` (`id_photo`, `id_board`, `photo`, `thumb`) VALUES
(1, 1, '41afe9aec229109b967f080fce61dba1.jpg', '497d0f297b7eef01e044994c021b5fe0.jpg'),
(2, 1, 'a50181e86336cfbd494f838d60f85aaa.jpg', '0e43d93eb84a42f68e9422f1239c9d59.jpg'),
(3, 1, 'bf91f46375eb549fe95601304d81125f.jpg', '6c69e758f93e32c0b8af90d79b9a6984.jpg'),
(4, 1, '2eac3cd98c11b62368f18b29489a45c6.jpg', '78aa0f0c75d4ed1b052a4b61932c0be7.jpg'),
(5, 2, '5f0285d4e37101b77c8d3910e165ec7a.jpg', '1614dbefbd6ccd2b6b78e1c76d98e9fc.jpg');
...
INSERT INTO `profile` (`id`, `user_id`, `username`, `phone`, `city_id`) VALUES
(1, 9, 'Петрович', NULL, NULL),
(3, 11, 'yyyyyyyyyyy', NULL, NULL),
(4, 13, 'Витаха', NULL, NULL),
(5, 14, 'Tester Tester', '333333333333', 10069),
(6, 15, 'Администратор', NULL, NULL),
(7, 16, 'sdfsdfsdfsd', NULL, NULL),
(8, 17, '', NULL, NULL),
(9, 18, '', NULL, NULL),
(10, 19, 'sss', NULL, NULL),
(11, 20, '', NULL, NULL),
(12, 21, '', NULL, NULL),
(13, 22, '', NULL, NULL),
(14, 23, 'zzzzzzz', NULL, NULL),
(15, 24, 'iiiiiiiiiiii', NULL, NULL),
(16, 25, 'cccccccccc', NULL, NULL),
(17, 26, 'asdasd asdasdas', NULL, NULL),
(18, 27, 'sdfsdf sdfsdfsdfsd', NULL, NULL),
(20, 29, 'dsadas asdasd asdasd', '45432423423', 10017);
...
--
-- Структура таблицы `stat_wm`
--

CREATE TABLE IF NOT EXISTS `stat_wm` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `types` (`id`, `filter`, `description`) VALUES
(1, '0', 'Выбрать фильтр для категории'),
(2, 'a:5:{s:1:"s";s:12:"Продам";s:1:"p";s:10:"Куплю";s:1:"u";s:10:"Меняю";s:1:"o";s:8:"Сдам";s:1:"c";s:10:"Сниму";}', 'Продам,Куплю,Меняю,Сдам,Сниму'),
(3, 'a:3:{s:1:"s";s:12:"Продам";s:1:"p";s:10:"Куплю";s:1:"u";s:10:"Меняю";}', 'Продам,Куплю,Меняю'),
(4, 'a:2:{s:1:"s";s:12:"Продам";s:1:"p";s:10:"Куплю";}', 'Продам,Куплю'),
(5, 'a:2:{s:1:"d";s:20:"Предлагают";s:1:"t";s:18:"Требуются";}', 'Предлагают,Требуются'),
(6, 'a:1:{s:1:"d";s:20:"Предлагают";}', 'Предлагают'),
(7, 'a:1:{s:1:"t";s:18:"Требуются";}', 'Требуются');
...
CREATE TABLE IF NOT EXISTS `user` (
  ...
  `forgot` varchar(255) DEFAULT NULL COMMENT 'Код для восстановления пароля',
  `change_code` varchar(255) DEFAULT NULL COMMENT 'Код для смены пароля',
  PRIMARY KEY (`id_user`),
  UNIQUE KEY `email` (`email`),
  UNIQUE KEY `login_UNIQUE` (`login`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 PACK_KEYS=0 CHECKSUM=1 AUTO_INCREMENT=30 ;

--
-- Дамп данных таблицы `user`
--

INSERT INTO `user` (`id_user`, `login`, `password`, `salt`, `email`, `active`, `superuser`, `forgot`, `change_code`) VALUES
(2, 'user', 'e72de15530c2315aa7c0cba633dcf4ba', 'acf7ef943fdeb3cbfed8dd0d8f584731', 'user10@mail.ru', 'yes', 1, '9812146bf54afe36c0c5a3f46754fddd', NULL),
(3, 'user222', 'f38fa523537217495918143536aff18e', 'b9d10f268fdc769283fb585b34c93901', 'user101@mail.ru', 'yes', 0, '4594105726ad551c10645284d7444471', NULL),
(4, 'testuser', 'bb9b7d8dd49b81b4bae1c21a957efba2', 'd41d8cd98f00b204e9800998ecf8427e', 'testuser@nm.ru', 'no', 0, '', NULL),
(5, 'wqeqw', 'bb9b7d8dd49b81b4bae1c21a957efba2', 'd41d8cd98f00b204e9800998ecf8427e', 'asdasdasdasda@mail.ru', 'no', 0, '', NULL),
(6, 'eqweq', 'e82a94f3716083d2f595508342e0c885', 'd41d8cd98f00b204e9800998ecf8427e', 'weqwasdasd@mail.ru', 'no', 0, '', NULL),
(9, 'foreach', '4edcae94673bf880df608f39409d6cb3', 'd41d8cd98f00b204e9800998ecf8427e', 'foreach@mail.ru', 'no', 0, '', NULL),
(11, 'nnnnnnnn', 'b11a660d6969dbc507ce94d0f27db170', 'd41d8cd98f00b204e9800998ecf8427e', 'nnnnnnnn@nm.ru', 'no', 0, '', NULL),
(13, 'vitaxa', '4edcae94673bf880df608f39409d6cb3', 'd41d8cd98f00b204e9800998ecf8427e', 'foreach222@mail.ru', 'no', 0, '', NULL),
(14, 'tester', '7a88074199e98c233d525487862e9d51', 'd41d8cd98f00b204e9800998ecf8427e', 'tester@nm.ru', 'yes', 0, NULL, NULL),
(15, 'rhbgnjuhfa', '960abbd3fefcbc5890c7953e2edf9a98', 'd41d8cd98f00b204e9800998ecf8427e', 'vitaxa_prog@mail.ru', 'yes', 1, NULL, NULL),
(16, 'dsdfsdfs', '940b7fb9ef1f6dfa3526080cd1f8c636', 'd41d8cd98f00b204e9800998ecf8427e', 'xczxcz@nm.ru', 'yes', 0, NULL, NULL),
(17, 'hhhhhhhhhhhh', 'b9cbe0aaac54abd474e16b1444c26380', 'd41d8cd98f00b204e9800998ecf8427e', 'hhhh@mail.ru', 'yes', 0, NULL, NULL),
(18, 'yyy', 'a3d4b7db54d722fac9db5bcd2d2f70a1', 'd41d8cd98f00b204e9800998ecf8427e', 'yyyyy@nm.ru', 'yes', 0, NULL, NULL),
(19, 'sss', '011e79f5d6d4252d2e8d566ef0ff2da0', 'd41d8cd98f00b204e9800998ecf8427e', 'sssss@nm.nm', 'yes', 0, NULL, NULL),
(20, 'vvvvvvvvv', 'e3ac0bc690288db880663d7dc54a3b5c', 'd41d8cd98f00b204e9800998ecf8427e', 'vvvvvvvvvvv@nm.ru', 'yes', 0, NULL, NULL),
(21, 'nnnnnnn', 'b11a660d6969dbc507ce94d0f27db170', 'd41d8cd98f00b204e9800998ecf8427e', 'nnnnnnnnnnn@nn.ru', 'yes', 0, NULL, NULL),
(22, 'mmmmm', 'd013c7a12e4480680dec47861269eb7b', 'd41d8cd98f00b204e9800998ecf8427e', 'mmmmmmmm@nn.ru', 'yes', 0, NULL, NULL),
(23, 'zzzz', '067dad51b1b6eec2b5cad0f51bec9a8a', 'd41d8cd98f00b204e9800998ecf8427e', 'zzzzzzz@nm.nm', 'yes', 0, NULL, NULL),
(24, 'iiiiii', '2d3e0c521b84089bfe344264406310bb', 'd41d8cd98f00b204e9800998ecf8427e', 'iiiiiiiii@nm.ru', 'yes', 0, NULL, NULL),
(25, 'ccccc', '05d27b877c74eaf40a96eb0cc3987a69', 'd41d8cd98f00b204e9800998ecf8427e', 'cccccccc@nm.ru', 'yes', 0, NULL, NULL),
(26, 'testmail', 'bb9b7d8dd49b81b4bae1c21a957efba2', 'd41d8cd98f00b204e9800998ecf8427e', 'teste3r@nm.ru', 'yes', 0, NULL, NULL),
(27, 'testmail2', 'bb9b7d8dd49b81b4bae1c21a957efba2', 'd41d8cd98f00b204e9800998ecf8427e', 'teste34r@nm.ru', 'yes', 0, NULL, NULL),
(29, 'sadqweqdasd asdasdasdas', 'bb9b7d8dd49b81b4bae1c21a957efba2', 'd41d8cd98f00b204e9800998ecf8427e', 'sssss1121@nm.nm', 'yes', 0, NULL, NULL);
...
--
ALTER TABLE `board`
  ADD CONSTRAINT `board_ibfk_1` FOREIGN KEY (`id_category`) REFERENCES `category` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION;

--
-- Ограничения внешнего ключа таблицы `category`
--
ALTER TABLE `category`
  ADD CONSTRAINT `category_ibfk_1` FOREIGN KEY (`type_filters`) REFERENCES `types` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Ограничения внешнего ключа таблицы `comments`
--
ALTER TABLE `comments`
  ADD CONSTRAINT `comments_ibfk_1` FOREIGN KEY (`id_board`) REFERENCES `board` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION;

--
-- Ограничения внешнего ключа таблицы `company`
--
ALTER TABLE `company`
  ADD CONSTRAINT `company_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `user` (`id_user`) ON DELETE CASCADE ON UPDATE NO ACTION;

--
-- Ограничения внешнего ключа таблицы `favorites`
--
ALTER TABLE `favorites`
  ADD CONSTRAINT `favorites_ibfk_1` FOREIGN KEY (`board_id`) REFERENCES `board` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION,
  ADD CONSTRAINT `favorites_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `user` (`id_user`) ON DELETE CASCADE ON UPDATE NO ACTION;

--
-- Ограничения внешнего ключа таблицы `location`
--
ALTER TABLE `location`
  ADD CONSTRAINT `location_ibfk_1` FOREIGN KEY (`board_id`) REFERENCES `board` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION;

--
-- Ограничения внешнего ключа таблицы `photo`
--
ALTER TABLE `photo`
  ADD CONSTRAINT `photo_ibfk_1` FOREIGN KEY (`id_board`) REFERENCES `board` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION;

--
-- Ограничения внешнего ключа таблицы `profile`
--
ALTER TABLE `profile`
  ADD CONSTRAINT `profile_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `user` (`id_user`) ON DELETE CASCADE ON UPDATE NO ACTION;

--
-- Ограничения внешнего ключа таблицы `stat_wm`
--
ALTER TABLE `stat_wm`
  ADD CONSTRAINT `fk_stat_wm_board1` FOREIGN KEY (`id_board`) REFERENCES `board` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Ограничения внешнего ключа таблицы `subscribe`
--
ALTER TABLE `subscribe`
  ADD CONSTRAINT `subscribe_ibfk_1` FOREIGN KEY (`id_board`) REFERENCES `board` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `subscribe_ibfk_2` FOREIGN KEY (`id_cat`) REFERENCES `category` (`id`) ON DELETE CASCADE;
