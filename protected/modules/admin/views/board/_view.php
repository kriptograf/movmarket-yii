...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('top_time')); ?>:</b>
	<?php echo CHtml::encode($data->top_time); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('time_delete')); ?>:</b>
	<?php echo CHtml::encode($data->time_delete); ?>
	<br />
