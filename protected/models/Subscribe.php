...
class Subscribe extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id_board, id_cat', 'required'),
			array('id_board, id_cat', 'numerical', 'integerOnly'=>true),
			array('mail, username', 'length', 'max'=>255),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, mail, username, id_board, id_cat', 'safe', 'on'=>'search'),
		);
	}
